...
public static class RenderUtilities
{
    public static void CreateBorderOnWord(SpriteBatch spriteBatch, SpriteFont font, string text, Vector2 position)
    {
        ...
        // Main string
        spriteBatch.DrawString(font, text, position, Color.Yellow, 0, Vector2.Zero, 1f, SpriteEffects.None, 0.5f); // Needed to draw main string on different layer to make it so it drew on top always
    }
